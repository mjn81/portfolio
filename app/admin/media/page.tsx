...
export default function MediaLibraryPage() {
  ...
  const [mediaDetails, setMediaDetails] = useState<null | (typeof mockMediaFiles)[0]>(null)

  // Filter media files based on search term and active tab
  const filteredMedia = mockMediaFiles.filter((file) => {
        ...
        <div className="flex gap-2">
          <Dialog>
            ...
            <DialogContent>
              ...
              <div
                className={`mt-4 rounded-lg border-2 border-dashed p-12 text-center ${isUploading ? "border-primary" : "border-border"}`}
              >
                {isUploading ? (
                    ...
                    <div className="relative h-full w-full bg-muted flex items-center justify-center overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                        ...
                        <Button
                          ...
                          size="icon"
                          className="h-8 w-8"
                          onClick={() => copyToClipboard(`https://example.com/media/${file.id}`)}
                        >
                    ...
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => copyToClipboard(`https://example.com/media/${file.id}`)}>
                            Copy link
                          </DropdownMenuItem>
              ...
              <div className="md:col-span-2 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-1">
                    <Input value={`https://example.com/media/${mediaDetails.id}`} readOnly className="text-xs" />
                    <Button
                      variant="outline"
                      size="icon"
                      onClick={() => copyToClipboard(`https://example.com/media/${mediaDetails.id}`)}
                    >
                      <LinkIcon className="h-4 w-4" />
                    </Button>
                  </div>
                ...
                <div className="space-y-2 pt-4">
                  <div className="flex gap-2 flex-wrap">
                    <Button onClick={() => window.open(`https://example.com/media/${mediaDetails.id}`, "_blank")}>
