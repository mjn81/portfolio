    ...
    <footer className="bg-background border-t border-border py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            <Link href="/" className="text-2xl font-bold mb-4 block relative group">
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#journey" className="text-foreground/70 hover:text-primary transition-colors">
                  Journey
                </Link>
              </li>
              <li>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                ...
                >
                  contact@mjnajafi.com
                </a>
              </li>
              <li>
                <a href="tel:+989123456789" className="text-foreground/70 hover:text-primary transition-colors">
                  +98 912 345 6789
                </a>
              </li>
            </ul>
